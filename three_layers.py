...
if __name__ == '__main__':
    ...
    middle_layer = MiddleLayer(6, sigmoid_activation, entry_layer)
    output_layer = OutputLayer(10, linear_activation, middle_layer)

    entry_layer.next_layer = middle_layer
    middle_layer.next_layer = output_layer
