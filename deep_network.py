...
BATCH_SIZE = 5
NB_EPOCHS = 40 # Nombre de fois que la base de données sera lue.
...
if __name__ == '__main__':
    ...
    model = torch.nn.Sequential(entry_layer, torch.nn.Sigmoid(), middle_layer_1, torch.nn.Sigmoid(), middle_layer_2, torch.nn.Sigmoid(), output_layer)
